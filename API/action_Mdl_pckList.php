...
if ($_POST['submit'] == 'SAVE' && $_POST['pack'] != "") {
    ...
    $qry = mysqli_query($con,"SELECT *, detail_pergerakan_stok.id AS kd
    ...
    while ($row = mysqli_fetch_array($qry)) {
        if ($_POST['check'][$n] != '') {
            ...
            $cek1 = mysqli_num_rows($cari1);
            if ($cek1 > 0) { // ubah data di detail_pergerakan stok
                mysqli_query($con,"UPDATE detail_pergerakan_stok SET refno='$listno',pack='".$_POST['pack']."',lott='".$_POST['id']."' WHERE id='$id_kite'");
                $json_data = array(
                    "kode"            => 200,
                ...
                mysqli_query($con,"insert into `packing_list` 
            ...
            mysqli_query($con,"UPDATE detail_pergerakan_stok SET refno='$listno',pack='".$_POST['pack']."',lott='".$_POST['id']."' where id='$id_kite'") or die("Gagal1  $id_kite");
            $n++;
        } else {
            $n++;
        }
