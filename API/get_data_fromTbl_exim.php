...
$sql = mysqli_query($con,"SELECT id, listno, tgl, nm_messrs, alt_messrs, nm_consign, alt_consign, shipment_by, payment, no_lc, tgl_lc, f_country, t_country, l_area, r_area, forwarder, f_atn, no_si,
                    ...
                    FROM tbl_exim where `listno`='".$_POST['listno']."'");
