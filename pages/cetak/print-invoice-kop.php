...
GROUP BY b.no_po ORDER BY id ASC");
	...
	border-right:1px #000000 solid;">&nbsp;</td>
                            ...
                            <?php
                            $sqldt1 = mysql_query("SELECT sum(if(a.sisa='FOC',0,a.weight)) as kgs,sum(if(a.sisa='FOC',0,a.yard_))as yds,sum(if(a.sisa='FOC',0,b.netto))as pcs,sum(if(a.sisa='FOC',a.weight,0)) as kgs_foc,sum(if(a.sisa='FOC',a.yard_,0))as yds_foc,b.ukuran,c.user_packing ,c.warna,d.unit_price,d.price_by
