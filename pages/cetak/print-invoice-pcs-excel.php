...
header("Content-Disposition: attachment; filename=invoice-pcs-no-" . $_GET['listno'] . ".xls"); //ganti nama sesuai keperluan
...
GROUP BY b.no_po ORDER BY id ASC ");
        ...
        while ($r1 = mysql_fetch_array($sql1)) {
            $sqldt1 = mysql_query("SELECT sum(if(a.sisa='FOC',0,a.weight)) as kgs,sum(if(a.sisa='FOC',0,a.yard_))as yds,sum(if(a.sisa='FOC',0,b.netto))as pcs,b.ukuran,c.user_packing ,c.warna
