...
header("Content-Disposition: attachment; filename=sa-no-" . $_GET['id'] . ".xls"); //ganti nama sesuai keperluan
    ...
    <table width="100%" border="0" class="noborder" style="width:7.8in;">
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" valign="top">DATED : <?php if ($r2[tgl] != "") {
            ...
            <tr>
                ...
                <td colspan="2" valign="top">DATED ISSUE: <?php if ($r[tgl_lc] != "0000-00-00") {
            ...
            <tr>
                ...
                <td valign="top">:</td>
                <td colspan="5" valign="top"><?php echo $r[f_country]; ?></td>
            </tr>
            <tr height="8">
                <td valign="top"></td>
                <td valign="top"></td>
            ...
            <tr>
                ...
                <td valign="top">:</td>
                <td colspan="5" valign="top" align="left"><?php echo $r[no_bl]; ?></td>
            </tr>
            <tr height="8">
                <td valign="top"></td>
                <td valign="top"></td>
