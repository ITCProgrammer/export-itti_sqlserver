...
<body>
  ...
  <?php
  $sql = mysql_query("SELECT a.*,b.nm_consign,b.alt_consign,b.nm_messrs,b.alt_messrs,b.payment,b.incoterm FROM tbl_exim_si a 
  ...
  <table width="100%" border="0" class="noborder" style="width:7.8in;">
    <tbody>
      ...
      <tr>
        ...
        <td valign="top">:</td>
        <td colspan="3" valign="top"><?php echo $r[nm_consign]; ?><br><?php echo $r[alt_consign]; ?></td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="top">:</td>
        <td colspan="3" valign="top"><?php echo $r[nm_messrs]; ?><br><?php echo $r[alt_messrs]; ?></td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="top">:</td>
        <td valign="top"><?php echo $r[payment]; ?> BY <?php echo $r[incoterm]; ?></td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
      ...
      <tr>
        ...
        <td valign="top">: <?php if ($r[etd_conn] != "" and $r[etd_conn] != "0000-00-00") {
