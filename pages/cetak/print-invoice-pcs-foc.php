...
<body>
    ...
    ?>
    <a href="print-invoice-pcs-foc-excel.php?listno=<?PHP echo $_GET[listno]; ?>&ket="><img src="../btn_print.png" width="20" height="22" alt="" id="nocetak" /></a>
...
ORDER BY a.lott ASC");
	...
	border-top:0px #000000 solid;
	border-left:1px #000000 solid;
	border-right:1px #000000 solid;"><span style="border-bottom:0px #000000 solid;
	...
	border-top:0px #000000 solid;
	border-left:1px #000000 solid;
	border-right:1px #000000 solid;"><?php if ($r2[ukuran] != "") {
                                            echo $r2[ukuran];
                                        } else {
                                            echo "-";
                                        } ?></td>
	...
	border-top:0px #000000 solid;
	border-left:1px #000000 solid;
	border-right:1px #000000 solid;"><?php if ($r2[pcs] != "") {
                                            echo $r2[pcs];
                                        } else {
                                            echo "-";
                                        } ?></td>
