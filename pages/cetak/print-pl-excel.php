...
header("Content-Disposition: attachment; filename=pl-no-" . date($_GET['listno']) . ".xls"); //ganti nama sesuai keperluan
...
<table width="100%" border="0" class="noborder" style="width:7.8in;">
    ...
    <tr>
        <td width="19%"><?php if ($rm[shipment_by] == "SEA") {
                            echo "VESSEL";
            ...
            NAME</td>
        <td width="32%">: <?php echo $rm[v_f_c_nm]; ?></td>
...
WHERE  `packing_list`.`listno`='$_GET[listno]'
GROUP BY detail_pergerakan_stok.nokk
ORDER BY detail_pergerakan_stok.lott,tbl_kite.no_lot ASC";
            }
...
WHERE  warna='$rowd[warna]'");
                ...
                <br />
                <table width="100%" border="1" align="center" class="table-list1">
                    <tr>
...
<table width="100%" border="1" cellpadding="0" class="table-list1" style="width:7.8in;">
...
<br>
<table width="100%" border="0" class="noborder" style="width:7in;">
    <tr>
