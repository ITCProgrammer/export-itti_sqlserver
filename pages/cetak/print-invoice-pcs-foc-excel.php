...
header("Content-Disposition: attachment; filename=invoice-pcs-foc-no-" . $_GET['listno'] . ".xls"); //ganti nama sesuai keperluan
...
<body>
    ...
    <table width="100%" border="0" class="noborder" style="width:7.8in;">
        ...
        <tr>
            ...
            <td colspan="2">TO : <?php echo $r[t_country]; ?></td>
        </tr>
        <tr>
            <td width="18%">TERM OF PAYMENT </td>
            <td width="32%">: <?php echo $r[payment]; ?></td>
        ...
        <tr>
            <td colspan="2" rowspan="2"><?php echo $r[l_area]; ?></td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
    ...
    <table width="100%" border="1" class="table-list1" style="width:7.8in">
        <tr align="center">
            <th rowspan="2" valign="middle" scope="col">NO</th>
            <th rowspan="2" valign="middle" scope="col">PO NO</th>
            <th rowspan="2" valign="middle" scope="col">DESCRIPTION</th>
            <th rowspan="2" valign="middle" scope="col">COLOR</th>
            <th rowspan="2" valign="middle" scope="col">UNIT PRICE</th>
            <th rowspan="2" valign="middle" scope="col">SIZE</th>
            <th colspan="3" scope="col">QTY</th>
            <th rowspan="2" valign="middle" scope="col">AMOUNT US$</th>
        </tr>
        <tr align="center">
            <th>KGS</th>
            <th>YDS</th>
...
GROUP BY b.no_po ORDER BY id ASC ");
        ...
        while ($r1 = mysql_fetch_array($sql1)) {
            $sqldt1 = mysql_query("SELECT sum(if(a.sisa='FOC',a.weight,a.weight)) as kgs,sum(if(a.sisa='FOC',a.yard_,a.yard_))as yds,sum(if(a.sisa='FOC',b.netto,b.netto))as pcs,b.ukuran,c.user_packing ,c.warna
FROM detail_pergerakan_stok a
INNER JOIN tmp_detail_kite b ON b.id=a.id_detail_kj
INNER JOIN tbl_kite c ON c.id=b.id_kite
WHERE refno='$_GET[listno]' AND c.warna='$r1[warna]' AND a.lott='$r1[id]'
GROUP BY b.ukuran,c.warna ");
            $r2 = mysql_fetch_array($sqldt1);
	...
	border-top:0px #000000 solid;"><?php echo $r1[no_po]; ?></td>
                <td style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><?php echo "PI NO.: " . $r1[no_order] . "<br>" . $r1[no_item] . " " . $r1[deskripsi]; ?></td>
                <td align="center" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;">&nbsp;</td>
                <td align="center" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;">&nbsp;</td>
	...
	border-top:0px #000000 solid;">&nbsp;</td>
            ...
            <?php
            $sqldt1 = mysql_query("SELECT sum(if(a.sisa='FOC',a.weight,a.weight)) as kgs,sum(if(a.sisa='FOC',a.yard_,a.yard_))as yds,sum(if(a.sisa='FOC',b.netto,b.netto))as pcs,b.ukuran,c.user_packing ,c.warna,d.unit_price,d.price_by
FROM detail_pergerakan_stok a
INNER JOIN tmp_detail_kite b ON b.id=a.id_detail_kj
INNER JOIN tbl_kite c ON c.id=b.id_kite
...
ORDER BY a.lott ASC");
	...
	border-top:0px #000000 solid;">&nbsp;</td>
                    <td style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;">&nbsp;</td>
                    <td align="center" valign="top" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><span style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><?php echo $r2[warna]; ?></span></td>
                    <td align="center" valign="top" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><span style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;">
                    ...
                    <td align="center" valign="top" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><?php if ($r2[ukuran] != "") {
                                        echo $r2[ukuran];
                                    } else {
                                        echo "-";
                                    } ?></td>
	...
	border-top:0px #000000 solid;">
                    ...
                    <td align="center" valign="top" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><?php if ($r2[pcs] != "") {
                                        echo $r2[pcs];
                                    } else {
                                        echo "-";
                                    } ?></td>
                    <td align="right" valign="top" style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;"><span style="border-bottom:0px #000000 solid;
	border-top:0px #000000 solid;">
                            <?php if ($r2[price_by] == "KGS") {
	...
	border-top:0px #000000 solid;">&nbsp;</td>
        ...
        <tr>
            ...
            <td align="center" valign="middle">&nbsp;</td>
            <td>&nbsp;</td>
            <td colspan="3" align="center" valign="middle">AMOUNT</td>
            ...
            <td align="center" valign="middle"><?php if ($pcs > 0) {
                                                    echo $pcs;
                                                } else {
                                                    echo "-";
                                                } ?></td>
