...
if( !isset($_SESSION['usernmEX']) || !isset($_SESSION['passwordEX']) ) {
 ?>
 <script>setTimeout("location.href='index.php'",500);</script> 
 <?php
 die( 'Illegal Acces' ); 
}
...
<body>
      <blockquote style="margin: 0px"><h1>Welcome <?php echo strtoupper($_SESSION['usernmEX']);?> at Indo Taichen Textile Industry</h1> </blockquote>
	<!-- Main content -->
