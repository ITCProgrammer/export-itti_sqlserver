	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<table id="tbl2" class="table table-bordered table-hover table-striped" width="100%">
				...
				<tbody>
					<?php
					$qry3 = sqlsrv_query($con, "SELECT *,b.no_invoice FROM db_qc.tbl_exim_pim_detail a 
					LEFT JOIN db_qc.tbl_exim_cim_detail b ON a.id=b.id_pimd
					...
					?>
						<tr>
							...
							<td>
								<div align="right"><?php echo $r['kg']; ?></div>
							</td>
							<td>
								<div align="right"><?php echo $r['panjang']; ?></div>
							</td>
