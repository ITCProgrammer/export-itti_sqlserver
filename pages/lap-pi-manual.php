    ...
    <div class="col-xs-12">
      <div class="box table-responsive">
        <div class="box-header with-border">
          <font size="+2" class="box-title">Data Proforma Invoice Manual</font>
        </div>
        <div class="box-body">
      ...
      a.*,
      CASE 
          WHEN EXISTS (SELECT 1 FROM db_qc.tbl_exim_pim_detail d WHERE d.id_pi = a.id AND d.status = 'Closed') 
          THEN 'Closed' 
          ELSE 'On Going' 
      END AS status,
      (SELECT SUM(kg) FROM db_qc.tbl_exim_pim_detail d WHERE d.id_pi = a.id) as kg
  FROM db_qc.tbl_exim_pim a
  ORDER BY status DESC, a.tgl_terima ASC");
              ...
              ?>
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center"><?php echo $r['tgl_terima']->format('Y-m-d'); ?></td>
                  ...
                  <td align="center"><?php echo $r['kg']; ?></td>
