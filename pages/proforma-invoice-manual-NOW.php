      ...
      <div class="col-xs-12">
        <div class="box table-responsive">
          <div class="box-header with-border">
            ...
            <br>
            <a href="?p=Form-Invoice-Manual" class="btn btn-primary pull-left" ><span class="fa fa-plus-circle"></span>
              Tambah</a>
          </div>
          <div class="box-body">
            <table id="example2" class="table table-bordered table-hover table-striped" style="width:100%">
              <thead class="bg-red">
                <tr>
                  ...
                  <th width="81"><div align="center">(Order) KGs</div></th>
                  <th width="81"><div align="center">(Export) KGs</div></th>
                  <th width="81"><div align="center">Sales</div></th>
                  <th width="81"><div align="center">Author</div></th>
	...
	?>
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center">
                    ...
                    else { echo "disabled" ; } ?>" onclick="confirm_del_mohon('?p=pi_hapus&id=<?php echo $r['id'] ?>');"><i class="fa fa-trash"></i> </a></td>
                </tr>
                <?php
  } ?>
              </tbody>
