				...
				<table id="example5" class="table table-bordered table-hover table-striped" width="100%">
					...
					?>
						<tr bgcolor="<?php echo $bgcolor; ?>">
							...
							<td><div align="center">
							  <?php if($r['POADD']==""){echo $r['PONumber'];}else{ echo $r['POADD']; } ?>
							  </div></td>
							<td><div align="center"><?php echo $r['ProductCode']; ?></div></td>
							<td><div align="center"><?php echo $r['Color']; ?></div></td>
							<td>&nbsp;</td>
							<td><div align="center"><?php echo $rHS['hs_code']; ?></div></td>
							<td><div align="right"><?php echo number_format($r['UnitPrice'],"3",".",""); ?></div></td>
							<td><div align="center">
							  <?php if($r['UnitName']=="yard"){echo"YD";}elseif($r['UnitName']=="kg"){echo"KG";}elseif($r['UnitName']=="pc"){echo"PC";} ?>
							  </div></td>
							<td><div align="right">
							  <?php if($r['UnitName']=="kg"){echo $r['QuantityToOrder'];}else{echo round($r['Weight']);} ?>
							  </div></td>
							<td><div align="right">
							  <?php if($r['UnitName']=="yard"){echo $r['QuantityToOrder'];} ?>
							  </div></td>
							<td>&nbsp;</td>
						</tr>
						<?php
