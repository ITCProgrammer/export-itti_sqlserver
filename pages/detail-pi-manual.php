<div class="row">
	<div class="col-xs-12">
		<div class="box">
			...
			<br>
            <a href="?p=Proforma-Invoice-Manual" class="btn btn-default pull-right" ><span class="fa fa-arrow-circle-left"></span>
              Kembali</a>	
		  </div>
			<div class="box-body">			
			  	<table id="example2" class="table table-bordered table-hover table-striped" width="100%">
					...
					<tbody>
					<?php 
					$qry3=sqlsrv_query($con,"SELECT a.*,b.no_pi,b.bon_order FROM db_qc.tbl_exim_pim_detail a 
					...
					$qryD=sqlsrv_query($con,"SELECT kg,panjang,pcs,satuan FROM db_qc.tbl_exim_cim_detail WHERE id_pimd='".$_GET['id']."'");
					...
					?>
						<tr bgcolor="<?php echo $bgcolor; ?>">
						  ...
						  <td align="center"><?php echo $r['no_pi']; ?></td>
							...
							<td align="center"><a href="#" class="edit_status" id="<?php echo $r['id']; ?>">
							  <?php if($r['status']=="On Going"){echo "<span class='label label-success'>".$r['status']."</span>";}else{echo "<span class='label label-danger'>".$r['status']."</span>";} ?>
							  </a></td>
							<td><div align="right"><a href="#" class="detail_datapi" id="<?php echo $r['id']; ?>">
							  <?php if(round($r['kg']-$rD['kg'],2)>0){
