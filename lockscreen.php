...
<html>
  ...
  <head>
    ...
    <title>Export Import | Lockscreen</title>
  ...
  <body class="hold-transition lockscreen ">
    ...
    <div class="lockscreen-wrapper">
      <div class="lockscreen-logo">
        <a href="index1.php"><b>Export ITTI</b></a>
      </div>
      ...
      <div class="lockscreen-item">
        ...
        <div class="lockscreen-image">
          <img src="dist/img/<?php echo $_SESSION['fotoEX'];?>.png" alt="User Image">
        </div>
        <!-- /.lockscreen-image -->
